...
export default function DaysGridView(props) {
  ...
  const firstDayOfMonth = startFromMonday ? moment(year+'/'+(month + 1)+'/1', 'jYYYY/jM/jD') : moment(year+'/'+(month + 1)+'/2', 'jYYYY/jM/jD');
  // The day() method returns the day of the week (from 0 to 6) for the specified date.
